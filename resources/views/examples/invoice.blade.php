...
@section('content_wrapper_for_without_footer')
          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="{{ route('examples', ['routeName'=>'invoice-print'])}}" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
